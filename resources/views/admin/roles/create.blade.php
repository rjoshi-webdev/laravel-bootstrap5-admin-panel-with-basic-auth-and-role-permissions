        ...
        <div class="page-content">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                {{ trans('cruds.role.title') }} {{ trans('global.create') }}</li></li>
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    {{-- <h6 class="mb-0 text-uppercase"> {{ trans('global.create') }} {{ trans('cruds.role.title_singular') }}
                    </h6> --}}
                    <hr />
                    <div class="card">
                        <div class="card-body">
                                ...
                                <form action="{{ route('admin.roles.store') }}" method="POST"
                                    ...
                                    <div class="form-group {{ $errors->has('permissions') ? 'has-error' : '' }}">
                                        <label for="permissions">{{ trans('cruds.role.fields.permissions') }}*
                                            ...
                                            <span
                                                class="btn btn-outline-danger px-1  btn-sm rounded-3 deselect-all">{{ trans('global.deselect_all') }}</span></label>
