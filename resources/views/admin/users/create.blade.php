...
@section('pageTitle')
    <title>{{ trans('cruds.user.title') }} {{ trans('global.create') }} </title>
@endsection
@section('styles')
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    {{-- <h6 class="mb-0 text-uppercase">{{ trans('cruds.user.title_singular') }} {{ trans('global.create') }} --}}
                    </h6>
                    <hr />
                    <div class="card">
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                ...
                                <form class="row g-3 needs-validation" novalidate action="{{ route('admin.users.store') }}"
