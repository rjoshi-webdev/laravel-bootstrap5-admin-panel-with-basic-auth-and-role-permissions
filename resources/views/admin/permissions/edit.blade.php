...
@section('pageTitle')
    <title>{{ trans('cruds.permission.title') }} {{ trans('global.edit') }}</title>
@endsection
@section('styles')
        ...
        <div class="page-content">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                {{ trans('cruds.permission.title_singular') }}  {{ trans('global.edit') }}</li></li>
            ...
            <div class="row">
                <div class="col-xl-12 mx-auto">
                    {{-- <h6 class="mb-0 text-uppercase">{{ trans('global.edit') }} {{ trans('cruds.permission.title_singular') }} </h6> --}}
                    <hr />
                    <div class="card">
                        <div class="card-body">
